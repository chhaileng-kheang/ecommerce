      ...
      child: Column(
        children: [
                ...
                Positioned(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                          width:  width*0.8,
                          child: Text("Location",style: GoogleFonts.montserrat(textStyle: TextStyle(color: Colors.white)),)),
                      SizedBox(height: 10,),
                      Container(
                        width: MediaQuery.sizeOf(context).width,
                        child: Row(
          ...
          Container(
            ...
            child: Hero(
              tag: "text",
              child: Text("Customer Info",style: Theme.of(context).textTheme.titleLarge!.copyWith(
