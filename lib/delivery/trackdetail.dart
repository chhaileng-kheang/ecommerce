                          ...
                          child: Column(
                            ...
                            children: [
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Pick-Up Location",style: GoogleFonts.montserrat(textStyle: TextStyle(fontSize: 14,color: Colors.black,fontWeight: FontWeight.w400)),),
                                  SizedBox(height: 5,),
                                  Container(
                                    width: 120,
                                    height: 2,
                              ...
                              Row(
                                ...
                                children: [
                                  Container(
                                      width: width*0.65,
                                      child: Text("Boeng Keng Kang 1, Khan Chamkar Mon,Phnom Penh",style: GoogleFonts.montserrat(textStyle: TextStyle(color: Colors.black,fontSize: 14,decoration: TextDecoration.underline)))),
                                  SizedBox(width: 15,),
                          ...
                          child: Column(
                            ...
                            children: [
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Customer Info",style: GoogleFonts.montserrat(textStyle: TextStyle(fontSize: 14,color: Colors.black,fontWeight: FontWeight.w400)),),
                                  SizedBox(height: 5,),
                                  Container(
                                    width:100,
                                    height: 2,
                              ...
                              SizedBox(height: 15,),
                              Text("Chan Sophea",style: GoogleFonts.montserrat(textStyle: TextStyle(fontSize: 16,color: Colors.black,fontWeight: FontWeight.bold)),),
                              SizedBox(height: 20,),
                              Row(
                                children: [
                                  Text("013 873 829",style: GoogleFonts.montserrat(textStyle: TextStyle(color: Colors.black,fontSize: 14, decoration: TextDecoration.underline))),
                                  SizedBox(width: 15,),
                              ...
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Location",style: GoogleFonts.montserrat(textStyle: TextStyle(fontSize: 14,color: Colors.black,fontWeight: FontWeight.w400)),),
                                  SizedBox(height: 5,),
                                  Container(
                                    width: 70,
                                    height: 2,
                          ...
                          child: Column(
                            ...
                            children: [
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Delivery Info",style: GoogleFonts.montserrat(textStyle: TextStyle(fontSize: 14,color: Colors.black,fontWeight: FontWeight.w400)),),
                                  SizedBox(height: 5,),
                                  Container(
                                    width:90,
                                    height: 2,
                              ...
                              SizedBox(height: 10,),
                              Text("Rottanak",style: GoogleFonts.montserrat(textStyle: TextStyle(fontSize: 14,color: Colors.black,fontWeight: FontWeight.bold)),),
                              SizedBox(height: 10,),
                              Row(
                                children: [
                                  Text("013 873 829",style: GoogleFonts.montserrat(textStyle: TextStyle(color: Colors.black,fontSize: 14, decoration: TextDecoration.underline))),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text("Tracking",style: GoogleFonts.montserrat(textStyle: TextStyle(fontSize: 14,color: Colors.black,fontWeight: FontWeight.w400)),),
                                        SizedBox(height: 5,),
                                        Container(
                                          width: 60,
                                          height: 2,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Text("Accepted",style: GoogleFonts.montserrat(textStyle: TextStyle(fontSize: 16,color: Colors.black,fontWeight: FontWeight.bold)),),
                                      ],
                                    ),
                                    SizedBox(height: 50,),
                                    Row(
