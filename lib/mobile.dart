            ...
            children: [
              ...
              Positioned(
                ...
                child: AnimatedContainer(
                  ...
                  padding: EdgeInsets.only(top:  isExpanded == false ? 0 : 10,left: isExpanded == false ? 0 : 5),
                  height: isExpanded == false ? 30 : MediaQuery.sizeOf(context).height*0.7,
                  width: isExpanded == false ? 30 : width *0.9,
                  decoration: isExpanded == true ? BoxDecoration(
                    color: Colors.white,
                    boxShadow: [
                      BoxShadow(
                    ...
                    borderRadius: BorderRadius.only(bottomRight: Radius.circular(50),bottomLeft: Radius.circular(10),topRight: Radius.circular(10),topLeft: Radius.circular(10))
                  ) : BoxDecoration(
                      color: Colors.white,
                  ),
                    ...
                    children: [
                      Container(
                        ...
                        child: InkWell(
                            ...
                            child: Icon(isExpanded == false ? Icons.menu : Icons.close,size: 28,color: Color.fromRGBO(255, 75, 75, 1.0),)),
                      ),
                      Expanded(
                        child: SingleChildScrollView(
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            SponsorCard(width, context, "https://images.unsplash.com/photo-1521223890158-f9f7c3d5d504?q=80&w=1492&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"),
            SponsorCard(width, context, "https://plus.unsplash.com/premium_photo-1675186049409-f9f8f60ebb5e?q=80&w=2187&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"),
            ...
            SponsorCard(width, context, "https://images.unsplash.com/photo-1434389677669-e08b4cac3105?q=80&w=2610&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"),
            SponsorCard(width, context, "https://images.unsplash.com/photo-1560769629-975ec94e6a86?q=80&w=2564&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"),
            ],
        ),
      ),
    );
           ...
           children: [
             Positioned(
               ...
               child: Container(width: width*0.4,
                 child:  Lottie.asset("asset/Animation - 1712806927475.json"),
               ),
             ),
             ...
             Column(
               ...
               crossAxisAlignment: CrossAxisAlignment.start,
               children: [
                 Text("Register As Merchant",style: GoogleFonts.montserrat(textStyle : TextStyle(fontSize: 14,color: Colors.black,fontWeight: FontWeight.bold)),),
                 Text("For Free",style: GoogleFonts.montserrat(textStyle : TextStyle(fontSize: 20,color: Colors.black,fontWeight: FontWeight.bold))),
                 Container(
                   ...
                   child: Text("Register",textAlign: TextAlign.center,style: GoogleFonts.montserrat(textStyle : TextStyle(fontSize: 12,color: Colors.white,fontWeight: FontWeight.bold))),
                 )
                ],
             ),
